...
@registry.register_model("blip2_t5_r")
class Blip2T5_R(Blip2Base):
    """
    BLIP2 T5 model.
    ...
    PRETRAINED_MODEL_CONFIG_DICT = {
        "pretrain_flant5xl": "configs/models/blip2/my_blip2_pretrain_flant5xl.yaml",
    ...
    def __init__(
        ...
        for i in range(24):
            for name, param in self.t5_model.encoder.block[i].layer[0].named_parameters():
                param.requires_grad = False
                #param.data = param.data.bfloat16()
        ...
        for i in range(24):
            for name, param in self.t5_model.decoder.block[i].layer[0].named_parameters():
                param.requires_grad = False
                #param.data = param.data.bfloat16()
                #self attention
